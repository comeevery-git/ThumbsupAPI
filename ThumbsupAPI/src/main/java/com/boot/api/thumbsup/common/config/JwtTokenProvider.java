 ...
 * claim 정보에 회원을 구분할 수 있는 값을 세팅하였다가 토큰이 들어오면 해당 값으로 회원을 구분하여 리소스를 제공하면 됩니다.
 * 그리고 Jwt토큰에는 expire 시간을 세팅할 수 있습니다. 토큰 발급 후 일정 시간 이후에는 토큰을 만료시키는 데 사용할 수 있습니다.
...
public class JwtTokenProvider { // JWT 토큰을 생성 및 검증 모듈
	...
	//secret key는 application.yaml에 세팅
    ...
    // Jwt 토큰 생성
    public String createToken(String mbId, List<String> roles) {
